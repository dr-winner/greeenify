        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Connecting farmers and consumers for fresher produce, sustainable
              living, and supporting local agriculture securely.
            </p>
          ...
          <div>
            ...
            <address className="not-italic text-gray-300 space-y-2">
              ...
              <p>
                Email:{" "}
                <a
                  href="mailto:hello@greenify.com"
